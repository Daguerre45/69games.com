...
import { Children as Children2, createElement as createElement2, isValidElement as isValidElement2, useRef } from "react";
...
function convertChildrenToMotionChildren(children, debug, customProps) {
  return Children.map(children, (child) => {
    ...
    const typeOfNewElement = isMotionComponent(node.type) ? node.type : m[childType];
...
function MagicCard({
  ...
  function convertChildrenToMagicCardChildren(nodes, depth) {
    return Children2.map(nodes, (child, i) => {
      let node = child;
  ...
  return /* @__PURE__ */ jsxs(LazyMotion, { features: domMax, children: [
    motionChildren,
    isCardExpanded && /* @__PURE__ */ jsx(
      "div",
      {
    ...
    isBackgroundFadeEnabled && /* @__PURE__ */ jsx(AnimatePresence, { children: isCardExpanded && /* @__PURE__ */ jsx(
      m2.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
...
function MagicMotion({
  ...
  return isMotionReduced || disabled ? /* @__PURE__ */ jsx2(Fragment, { children }) : /* @__PURE__ */ jsx2(LayoutGroup, { children: /* @__PURE__ */ jsx2(LazyMotion2, { features: domMax2, children: motionChildren }) });
}

// magic-tab-select/index.tsx
import { m as m3, LazyMotion as LazyMotion3, domMax as domMax3 } from "framer-motion";
...
function MagicTabSelect({
  ...
  if (typeof motionChildren.type === "function") {
    ...
    if (motionChildren === null)
      motionChildren = /* @__PURE__ */ jsx3(Fragment2, {});
  }
  const childType = motionChildren.type;
  const motionElement = createElement3(
    m3[childType],
    __spreadProps(__spreadValues({}, motionChildren.props), { layoutId: id, transition }),
    motionChildren.props.children
  );
  return isMotionReduced || disabled ? /* @__PURE__ */ jsx3(Fragment2, { children }) : /* @__PURE__ */ jsx3(LazyMotion3, { features: domMax3, children: motionElement });
}
